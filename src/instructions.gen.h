/* generated from generate_instructions.py: l.5895 */
#pragma once
...
/* 0x10     BPL */
extern enum InstructionStatus bpl(struct SPC_State state[static 1], uint32_t cycle);
/* 0x20     CLRP */
extern enum InstructionStatus clrp(struct SPC_State state[static 1], uint32_t cycle);
/* 0x30     BMI */
extern enum InstructionStatus bmi(struct SPC_State state[static 1], uint32_t cycle);
/* 0x40     SETP */
extern enum InstructionStatus setp(struct SPC_State state[static 1], uint32_t cycle);
/* 0x50     BVC */
extern enum InstructionStatus bvc(struct SPC_State state[static 1], uint32_t cycle);
/* 0x60     CLRC */
extern enum InstructionStatus clrc(struct SPC_State state[static 1], uint32_t cycle);
/* 0x70     BVS */
extern enum InstructionStatus bvs(struct SPC_State state[static 1], uint32_t cycle);
/* 0x80     SETC */
extern enum InstructionStatus setc(struct SPC_State state[static 1], uint32_t cycle);
/* 0x90     BCC */
extern enum InstructionStatus bcc(struct SPC_State state[static 1], uint32_t cycle);
/* 0xa0     EI */
extern enum InstructionStatus ei(struct SPC_State state[static 1], uint32_t cycle);
/* 0xb0     BCS */
extern enum InstructionStatus bcs(struct SPC_State state[static 1], uint32_t cycle);
/* 0xc0     DI */
extern enum InstructionStatus di(struct SPC_State state[static 1], uint32_t cycle);
/* 0xd0     BNE */
extern enum InstructionStatus bne(struct SPC_State state[static 1], uint32_t cycle);
/* 0xe0     CLRV */
extern enum InstructionStatus clrv(struct SPC_State state[static 1], uint32_t cycle);
/* 0xf0     BEQ */
extern enum InstructionStatus beq(struct SPC_State state[static 1], uint32_t cycle);
...
/* 0x1c     ASL   A */
extern enum InstructionStatus asl_a(struct SPC_State state[static 1], uint32_t cycle);
/* 0x2c     ROL   !a */
extern enum InstructionStatus rol_absolute(struct SPC_State state[static 1], uint32_t cycle);
/* 0x3c     ROL   A */
extern enum InstructionStatus rol_a(struct SPC_State state[static 1], uint32_t cycle);
/* 0x4c     LSR   !a */
extern enum InstructionStatus lsr_absolute(struct SPC_State state[static 1], uint32_t cycle);
/* 0x5c     LSR   A */
extern enum InstructionStatus lsr_a(struct SPC_State state[static 1], uint32_t cycle);
/* 0x6c     ROR   !a */
extern enum InstructionStatus ror_absolute(struct SPC_State state[static 1], uint32_t cycle);
/* 0x7c     ROR   A */
extern enum InstructionStatus ror_a(struct SPC_State state[static 1], uint32_t cycle);
/* 0x8c     DEC   !a */
extern enum InstructionStatus dec_absolute(struct SPC_State state[static 1], uint32_t cycle);
/* 0x9c     DEC   A */
extern enum InstructionStatus dec_a(struct SPC_State state[static 1], uint32_t cycle);
/* 0xac     INC   !a */
extern enum InstructionStatus inc_absolute(struct SPC_State state[static 1], uint32_t cycle);
/* 0xbc     INC   A */
extern enum InstructionStatus inc_a(struct SPC_State state[static 1], uint32_t cycle);
/* 0xcc     MOV   !a, y */
extern enum InstructionStatus mov_absolute_y(struct SPC_State state[static 1], uint32_t cycle);
/* 0xdc     DEC   Y */
extern enum InstructionStatus dec_y(struct SPC_State state[static 1], uint32_t cycle);
/* 0xec     MOV   Y, !a */
