/* generated from generate_instructions.py: l.647 */
...
{
    /* generated from generate_instructions.py: l.417 */
...
bool or_register_immediate_a(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    /* payload */
    /* generated from generate_instructions.py: l.338 */
    cpu->a |= cpu->data8[0];
    {
...
bool sbc_register_immediate_a(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    /* generated from generate_instructions.py: l.483 */
    cpu->a = cpu->data8[0];
    return true;
}
