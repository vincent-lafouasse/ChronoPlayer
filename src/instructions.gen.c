...
bool or_register_direct_a(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    switch (cycle) {
        ...
        case 3: {
            ...
            /* payload */
            /* generated from generate_instructions.py: l.718 */
            cpu->a |= cpu->data8[0];
            {
                /* generated from generate_instructions.py: l.612 */
...
bool cmp_register_direct_a(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    switch (cycle) {
        ...
        case 3: {
            ...
            /* payload */
            {
                /* generated from generate_instructions.py: l.697 */
...
bool adc_register_direct_a(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    switch (cycle) {
        ...
        case 3: {
            ...
            /* payload */
            {
                /* generated from generate_instructions.py: l.626 */
...
bool sbc_register_direct_a(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    switch (cycle) {
        ...
        case 3: {
            ...
            /* payload */
            {
                /* generated from generate_instructions.py: l.661 */
                const uint32_t operand_a = (uint32_t)(cpu->a);
                const uint32_t operand_b = (uint32_t)(cpu->data8[0]);
            ...
            /* generated from generate_instructions.py: l.333 */
            cpu->a = cpu->data8[0];
            return true;
        }
        default:
...
bool adc_register_immediate_a(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    /* generated from generate_instructions.py: l.155 */
    cpu->a = cpu->data8[0];
    return true;
}
...
bool sbc_register_immediate_a(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    /* generated from generate_instructions.py: l.165 */
    cpu->a = cpu->data8[0];
    return true;
}
...
{
/* generated from generate_instructions.py: l.756 */
    struct CPU_State* const cpu = &state->cpu;
