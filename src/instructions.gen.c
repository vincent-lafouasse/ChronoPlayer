/* generated from generate_instructions.py: l.900 */
...
{
    /* generated from generate_instructions.py: l.190 */
    struct CPU_State* const cpu = &state->cpu;
...
bool adc_register_direct_a(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    switch (cycle) {
        ...
        case 3: {
            ...
            /* generated from generate_instructions.py: l.673 */
            cpu->a = cpu->data8[0];
            return true;
        }
        default:
...
bool adc_register_direct_indexed_a_x(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    switch (cycle) {
        ...
        case 4: {
            ...
            /* generated from generate_instructions.py: l.734 */
            cpu->a = cpu->data8[0];
            return true;
        }
        default:
...
bool sbc_register_direct_a(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    switch (cycle) {
        ...
        case 3: {
            ...
            /* payload */
            {
                /* generated from generate_instructions.py: l.349 */
                const uint32_t operand_a = (uint32_t)(cpu->a);
                const uint32_t operand_b = (uint32_t)(cpu->data8[0]);
            ...
            /* generated from generate_instructions.py: l.683 */
            cpu->a = cpu->data8[0];
            return true;
        }
        default:
...
bool sbc_register_direct_indexed_a_x(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    switch (cycle) {
        ...
        case 4: {
            ...
            /* generated from generate_instructions.py: l.807 */
            cpu->a = cpu->data8[0];
            return true;
        }
        default:
...
bool adc_register_immediate_a(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    /* generated from generate_instructions.py: l.568 */
    cpu->a = cpu->data8[0];
    return true;
}
