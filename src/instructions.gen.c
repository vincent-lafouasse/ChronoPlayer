...
{
    /* generated from generate_instructions.py: l.803 */
...
bool or_register_direct_a(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    switch (cycle) {
        ...
        case 3: {
            ...
            /* payload */
            /* generated from generate_instructions.py: l.706 */
            cpu->a |= cpu->data8[0];
            {
...
bool adc_register_direct_a(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    switch (cycle) {
        ...
        case 3: {
            ...
            /* generated from generate_instructions.py: l.317 */
            cpu->a = cpu->data8[0];
            return true;
        }
        default:
...
bool adc_register_direct_indexed_a_x(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    switch (cycle) {
        ...
        case 4: {
            ...
            /* generated from generate_instructions.py: l.443 */
            cpu->a = cpu->data8[0];
            return true;
        }
        default:
...
bool sbc_register_direct_a(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    switch (cycle) {
        ...
        case 3: {
            ...
            /* payload */
            {
                /* generated from generate_instructions.py: l.649 */
                const uint32_t operand_a = (uint32_t)(cpu->a);
                const uint32_t operand_b = (uint32_t)(cpu->data8[0]);
...
bool sbc_register_direct_indexed_a_x(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    switch (cycle) {
        ...
        case 4: {
            ...
            /* generated from generate_instructions.py: l.522 */
            cpu->a = cpu->data8[0];
            return true;
        }
        default:
...
{
    /* generated from generate_instructions.py: l.92 */
    struct CPU_State* const cpu = &state->cpu;
...
bool adc_register_immediate_a(struct SPC_State state[static 1], uint32_t cycle)
{
    ...
    /* generated from generate_instructions.py: l.156 */
    cpu->a = cpu->data8[0];
    return true;
}
...
{
/* generated from generate_instructions.py: l.744 */
    struct CPU_State* const cpu = &state->cpu;
